...
//Poner el titulo con TYPED
document.addEventListener("DOMContentLoaded", function () {
    const typed = new Typed('.typed', {
        strings: ['<p class="titulo-essential-neon">PURPLE PULSE BOOSTER</p>'],
...
const DesarrolloWebLink = document.querySelector(".essential-li:nth-child(7) .essential-link");
// Obtener referencias a los contenedores de video
...
const textoExplicativo7 = document.querySelector(".video-explicativo7");
...
const miVideo7 = document.getElementById('miVideo7');
...
textoExplicativo7.style.opacity = 0;
...
textoExplicativo7.style.zIndex = 0;
...
growthMarketingLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos = [textoExplicativo2,textoExplicativo3,textoExplicativo4,textoExplicativo5,textoExplicativo6,textoExplicativo7];
    ArraydeLinks = [contentScriptsLink,VideoEditingLink,MarketingInfluencersLink,MarketingAfiliadosLink,SEOLink,DesarrolloWebLink];
    ArrayVideos = [miVideo2,miVideo3,miVideo4,miVideo5,miVideo6,miVideo7];
...
contentScriptsLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos= [textoExplicativo1,textoExplicativo3,textoExplicativo4,textoExplicativo5,textoExplicativo6,textoExplicativo7];
    ArraydeLinks = [growthMarketingLink,VideoEditingLink,MarketingInfluencersLink,MarketingAfiliadosLink,SEOLink,DesarrolloWebLink];
    ArrayVideos = [miVideo1,miVideo3,miVideo4,miVideo5,miVideo6,miVideo7];
...
VideoEditingLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos= [textoExplicativo1,textoExplicativo2,textoExplicativo4,textoExplicativo5,textoExplicativo6,textoExplicativo7];
    ArraydeLinks = [growthMarketingLink,contentScriptsLink,MarketingInfluencersLink,MarketingAfiliadosLink,SEOLink,DesarrolloWebLink];
    ArrayVideos = [miVideo1,miVideo2,miVideo4,miVideo5,miVideo6,miVideo7];
...
MarketingInfluencersLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos= [textoExplicativo1,textoExplicativo2,textoExplicativo3,textoExplicativo5,textoExplicativo6,textoExplicativo7];
    ArraydeLinks = [growthMarketingLink,contentScriptsLink,VideoEditingLink,MarketingAfiliadosLink,SEOLink,DesarrolloWebLink];
    ArrayVideos = [miVideo2,miVideo3,miVideo1,miVideo5,miVideo6,miVideo7];
...
MarketingAfiliadosLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos= [textoExplicativo1,textoExplicativo2,textoExplicativo3,textoExplicativo4,textoExplicativo6,textoExplicativo7];
    ArraydeLinks = [growthMarketingLink,contentScriptsLink,VideoEditingLink,MarketingInfluencersLink,SEOLink,DesarrolloWebLink];
    ArrayVideos = [miVideo2,miVideo3,miVideo4,miVideo1,miVideo6,miVideo7];
...
SEOLink.addEventListener("click", function (event) {
    ...
    ArraydeTextos= [textoExplicativo1,textoExplicativo2,textoExplicativo3,textoExplicativo4,textoExplicativo5,textoExplicativo7];
    ArraydeLinks = [growthMarketingLink,contentScriptsLink,VideoEditingLink,MarketingInfluencersLink,MarketingAfiliadosLink,DesarrolloWebLink];
    ArrayVideos = [miVideo2,miVideo3,miVideo4,miVideo5,miVideo1,miVideo7];
...
//************************************************************************************************************/
//BLOQUE 7
DesarrolloWebLink.addEventListener("click", function (event) {
    event.preventDefault();

    ArraydeTextos= [textoExplicativo1,textoExplicativo2,textoExplicativo3,textoExplicativo4,textoExplicativo5,textoExplicativo6];
    ArraydeLinks = [growthMarketingLink,contentScriptsLink,VideoEditingLink,MarketingInfluencersLink,MarketingAfiliadosLink,SEOLink];
    ArrayVideos = [miVideo2,miVideo3,miVideo4,miVideo5,miVideo6,miVideo1];
    ...
    for (let i = 0; i < ArraydeTextos.length; i++) {
        ...
        if(ArraydeTextos[i].style.opacity >= 0.99){
            ...
            fadeOut(ArraydeTextos[i]);
            fadeIn(textoExplicativo7);
            textoExplicativo7.style.zIndex = 3 ;
            DesarrolloWebLink.parentElement.classList.add('clicked');
            for(let a = 0; a < ArraydeLinks.length; a++){
                ArraydeLinks[a].parentElement.classList.remove('clicked');
            }
        }
